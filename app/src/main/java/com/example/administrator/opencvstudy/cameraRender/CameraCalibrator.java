package com.example.administrator.opencvstudy.cameraRender;
...
public class CameraCalibrator {
    ...
    private void renderFrame(Mat rgbaFrame) {
        ...
        Imgproc.putText(rgbaFrame, "Captured: -----" + mCornersBuffer.size(), new Point(rgbaFrame.cols() * 0.1, rgbaFrame.rows() * 0.1),
                Core.FONT_HERSHEY_SIMPLEX, 2.0, new Scalar(255, 0, 0));
    }
