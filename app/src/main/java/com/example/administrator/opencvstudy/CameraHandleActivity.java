...
public class CameraHandleActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_handle);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        switch (Cur_State) {
            ...
            case 6:
                ...
                Imgproc.rectangle(mZoomWindow, new Point(1, 1), new Point(wsize.width - 2, wsize.height - 2), new Scalar(255, 0, 0, 255), 18);
